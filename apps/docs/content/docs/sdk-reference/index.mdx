...
<Cards>
  <Card title="TipClient Class" href="/docs/sdk-reference/tip-client">
    Exhaustive reference for the `TipClient` class constructor, read methods, write methods, and auth flow.
  </Card>
  <Card title="On-Chain Resolution" href="/docs/sdk-reference/on-chain-resolution">
    Direct RPC resolution methods (`resolveOnChain`) and PDA seed derivation utilities (`deriveTagPda`).
  </Card>
  <Card title="Tag Utilities & Constants" href="/docs/sdk-reference/tag-utilities">
    Local tag validation (`normalizeTag`, `isValidTag`, `isReservedTag`) and exported constants.
  </Card>
  <Card title="Types & Models" href="/docs/sdk-reference/types-and-models">
    Complete list of TypeScript interfaces, parameters, and response structures.
  </Card>
  <Card title="Errors & Exceptions" href="/docs/sdk-reference/errors-and-exceptions">
