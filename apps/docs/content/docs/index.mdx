...
<div style={{display:"flex",alignItems:"center",gap:"8px",marginTop:"-4px"}}>
  <span style={{fontSize:"12px",color:"var(--fd-muted-foreground)"}}>Documentation version:</span>
  <span style={{display:"inline-flex",alignItems:"center",fontSize:"11px",fontWeight:700,padding:"2px 10px",borderRadius:"999px",background:"#16a34a",color:"#fff",fontFamily:"var(--font-geist-mono,monospace)"}}>v1.0.0</span>
</div>
...
<Cards>
  ...
  <Card title="Integration Guides" href="/integration-guides">
  ...
  <Card title="REST API Reference" href="/api-reference">
