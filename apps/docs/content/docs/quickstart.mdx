...
try {
  ...
  console.log("Payment Wallet:", result.wallet);  // "4vcgrBuzoWw3kBanVTtx7Pi1v9WyTJBJQsFAQMqjJZjx"
...
- Explore [Integration Guides](/docs/integration-guides) for tag registration, profile management, and wallet authentication.
- Browse the complete [SDK Reference](/docs/sdk-reference) for detailed API method signatures and types.
